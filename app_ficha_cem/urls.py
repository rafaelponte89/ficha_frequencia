from .views import gerar_ficha, faltas, atualizar_pessoa, \
      listar_ficha, encerrar_ano, pessoas, pessoas_faltas, pdf, imprimir, cargos, lancar_pontuacoes, atualizar_pontuacoes, excluir_pontuacoes
...
urlpatterns = [
    ...
    path('pessoas/<int:pessoa_id>/fichas/<int:ano>/', pdf, name='baixarpdf'),
